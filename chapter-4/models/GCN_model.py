...
if __name__ == "__main__":
    print("hello")
    model =GCN(input_feature=35, hidden_feature=35, p_dropout=0.5,
                        num_stage=12, node_n=64, variational='varitional', n_z=8, num_decoder_stage=6)

    input = torch.randn([16, 48, 35], dtype=torch.float32)
    out = model(input)
    print(out.shape)