...
class Options:
    ...
    def _initial(self):
        ...
        #self.parser.add_argument('--epochs', type=int, default=2)#50
        ...
        self.parser.add_argument('--variational', dest='variational', action='store_true', help='include flag to make generative enhanced')
